      ...
      <main className="container mx-auto px-4 py-6 md:py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 md:py-16 px-4">
            ...
            <p className="text-sm md:text-base text-muted-foreground">
              Tente ajustar sua pesquisa ou navegue pelos eventos disponíveis
            </p>
          </div>
        ) : (
          <>
          ...
          <>
            ...
            {filteredCampaigns.length === 0 && (
              <div className="text-center py-12 md:py-16 px-4">
                ...
                <Link to="/auth">
                  <Button className="bg-primary text-primary-foreground hover:bg-primary/90 text-sm md:text-base">
